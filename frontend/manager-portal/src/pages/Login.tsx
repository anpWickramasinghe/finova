                ...
                <div className="relative z-10">
                    ...
                    <div className="max-w-md">
                        ...
                        <p className="text-primary-foreground/80 text-lg leading-relaxed">
                            Log in to your manager portal to streamline workflows, approve pending tasks, and analyze actionable insights across your department.
                        </p>
                    </div>
                </div>
                        ...
                        <div className="space-y-4">
                            <div className="space-y-2">
                                ...
                                <Input
                                    id="email"
                                    type="email"
                                    placeholder="manager@finova.com"
                                    value={email}
