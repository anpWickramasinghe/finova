...
const TxnRow: React.FC<{ t: Transaction; onClick: (t: Transaction) => void }> = ({ t, onClick }) => {
    ...
    return (
        <div className="space-y-3">
            {groups.map(group => {
                ...
                return (
                    <div key={group.key} className="rounded-md border bg-card overflow-hidden">
                        {/* Month header */}
                        <button
                            type="button"
                        ...
                        >
                            ...
                            <div className="flex items-center gap-4 font-mono text-xs font-medium">
                                ...
                                <span className={net >= 0 ? 'text-emerald-600' : 'text-orange-600'}>
                                    Net {net >= 0 ? '' : '-'}{fmtMoney(String(Math.abs(net)))}
                                </span>
                            </div>
                        </button>
...
const TransactionTable: React.FC<TransactionTableProps> = ({
    ...
    if (groupByMonth) {
        ...
        return <GroupedTable groups={groups} onTransactionClick={onTransactionClick} />;
    }
